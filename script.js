    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ונטורה רואי חשבון ושות' משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1b12ece8-3ae4-4cfd-a422-8bd1e5555059',
                    name: data.name || '',
                    email: data.email || '',
